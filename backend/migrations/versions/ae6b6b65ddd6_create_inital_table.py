...
Revision ID: ae6b6b65ddd6
Revises: 
Create Date: 2023-06-30 13:14:52.932771
...
def upgrade() -> None:
    ...
    op.create_table('cart_product_check',
    sa.Column('cart_product_check_id', sa.String(), nullable=False),
    sa.Column('product_id', sa.String(), nullable=True),
    sa.Column('cart_id', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['cart_id'], ['cart.cart_id'], ),
    sa.ForeignKeyConstraint(['product_id'], ['product.product_id'], ),
    sa.PrimaryKeyConstraint('cart_product_check_id')
    )
    ...
    sa.Column('cart_product_check_id', sa.String(), nullable=True),
    sa.Column('user_id', sa.String(), nullable=True),
    sa.Column('order_id', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('order_date', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['cart_product_check_id'], ['cart_product_check.cart_product_check_id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('order_id'),
    sa.UniqueConstraint('cart_product_check_id'),
    sa.UniqueConstraint('user_id')
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('order')
    op.drop_table('cart_product_check')
